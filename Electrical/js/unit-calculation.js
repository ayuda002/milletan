...
$('button').on('click', function () {
   ...
   //専門共通科目
   var sc1 = ($('.sc-unit1').length) * 1;
   var sc2 = ($('.sc-unit2').length) * 2;
   var sc = sc1 + sc2;
   document.getElementById("sc").innerHTML = sc + "/8";
   //専門科目
   var s1_2 = ($('.s1-unit2').length) * 2;
   var s1 = s1_2;
   document.getElementById("s1").innerHTML = s1 + "/2";

   var s2 = ($('.s2-unit2').length) * 2;
   document.getElementById("s2").innerHTML = s2 + "/8";

   var s3 = ($('.s3-unit2').length) * 2;
   document.getElementById("s3").innerHTML = s3 + "/8";

   var s4 = ($('.s4-unit2').length) * 2;
   document.getElementById("s4").innerHTML = s4 + "/6";

   var s_unit = s1 + s2 + s3 + s4;
   ...
   document.getElementById("i-unit").innerHTML = i_unit + "/28";

   //専門科目合計
   var spe = sb_unit + sc + s_unit + i_unit;
